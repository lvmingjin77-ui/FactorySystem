...
class ShowCheckInNumDemo extends StatefulWidget {
  // final Function(int signInCount, int signOutCount, int comeLateCount, int leaveEarlyCount) updateCheckCallBack;

  const ShowCheckInNumDemo({super.key});
  // const ShowCheckInNum({super.key, required this.updateCheckCallBack});

  @override
  State<ShowCheckInNumDemo> createState() => ShowCheckInNumDemoState();
}

class ShowCheckInNumDemoState extends State<ShowCheckInNumDemo> {
  int currentSignInCount = 83;
  int currentSignOutCount = 94;
  int currentComeLateCount = 13;
  int currentLeaveEarlyCount = 5;
